...
getCanvasRequestAnimFrameFunc: function() {
    if (this.canvasNativeFrameTimesSupported()) {
        if (window.mozRequestAnimationFrame) return window.mozRequestAnimationFrame; //fix for ff23.0 (window.requestAnimationFrame is supported but doesn't work as expected)
