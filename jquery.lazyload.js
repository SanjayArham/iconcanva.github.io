        ...
        this.each(function() {
            ...
            $self.one("appear", function() {
                if (!this.loaded) {
                    ...
                    var hasLazyCls = $self.hasClass(settings.lazyCls);
                    var $img = $("<img />")
                        .bind("load", function() {
                            if (hasLazyCls) { 
                                $self
                                    ...
                                    if ($self.hasClass(settings.noLazyEffectCls)) {
                                        $self.show();
                                    } else {
                        ...
                        if (hasLazyCls) $img.attr("src", $self.data(settings.data_attribute));
                }
            });
